...
class Vec2{
    ...
    distanceSquared(v){
        return Vec2.distanceSquared(this, v);
    }
...
Vec2.isEqual = function(a, b){
    return Vec2.subtract(a, b).lengthSquared() < 0.000000000001;
}
...
Vec2.getDistance = function(a, b){
    return Vec2.subtract(a, b).length();
}

Vec2.getDistanceSquared = function(a, b){
    return Vec2.subtract(a, b).lengthSquared();
}
