...
export class Mat3{
    ...
    /**
     * 应用矩阵变换，产生新的点
     * @param {Vec2} pos 需要变换的点
     * @returns {Vec2}  返回变换后的点
     */
    apply(pos){
        ...
        const d = x * this.#data[6] + y * this.#data[7] + this.#data[8];
        p.x = (x * this.#data[0] + y * this.#data[1] + this.#data[2]) / d;
        p.y = (x * this.#data[3] + y * this.#data[4] + this.#data[5]) / d;
